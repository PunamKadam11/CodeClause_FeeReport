...
public class db_connection extends javax.swing.JFrame {
    ...
    public db_connection() {
        ...
        try{
            ...
            conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/bank_db?zeroDateTimeBehavior=CONVERT_TO_NULL","root","");
            state=conn.createStatement();
            JOptionPane.showMessageDialog(null,"Connected");
            
        }catch(Exception e){
            JOptionPane.showMessageDialog(null,e+"Error in connectiing to database");

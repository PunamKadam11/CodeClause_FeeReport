...
public class AccountantSection extends JFrame implements ActionListener {
    ...
    AccountantSection() {
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("FeeReportManagement/icons/student.jpg"));
        Image img2 = img.getImage().getScaledInstance(170, 200, Image.SCALE_DEFAULT);

...
public class DueFees extends JFrame{
    String x[] = {"Roll No","Name", "Email", "Mobile", "Course","Year","Fees","Paid","Due","Address","City"};
    String y[][] = new String[20][11];
    int i=0,j=0;
    JTable t;
    Font f;
    DueFees(){
        super("Due Student Section");
        setSize(800, 400);
        setLocation(1, 1);
         ...
         try{
            ...
            String q="Select * From student where due >0 AND paid < 34000";
